...
- 描述了$\alpha$个独立指数分布/若干个GammaF分布的$Gamma(\alpha_1,\beta)+Gamma(\alpha_2,\beta)=Gamma(\alpha_1+\alpha_2,\beta)$
...
| 参数           | 随机变量$\chi_n$                                          | PDF                                                          | 期望                   | 方差                     |
| -------------- | --------------------------------------------------------- | ------------------------------------------------------------ | ---------------------- | ------------------------ |
| $\alpha,\beta$ | 即发生概率为$\beta$的事件,在$x$时刻出现第$\alpha$次的概率 | $f_{\alpha,\beta}(x) = \frac{\beta^\alpha}{\Gamma(\alpha)}x^{\alpha-1}e^{-\beta x}$ | $\frac{\alpha}{\beta}$ | $\frac{\alpha}{\beta^2}$ |
